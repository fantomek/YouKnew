...
public class QuestionContentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cur_answer=findViewById(R.id.cur_answers);
...
//                intent.putExtra("username", user_name);
        ...
        //跳到回答详情页面
        cur_answer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(QuestionContentActivity.this, CurAnswer.class);
                intent.putExtra("q_title",q_title);
                intent.putExtra("username",user_name);
                intent.putExtra("q_info",q_info);
                intent.putExtra("q_username",q_username);
